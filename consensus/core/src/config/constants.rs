pub mod consensus {
    ...
    pub const NEW_FINALITY_DURATION: u64 = 54_000; // 15 hours = 432000 Blocks

    /// **New** pruning duration expressed in time units (seconds).
    /// Pruning Depth = ϕ+2M+4KL+2K+2
    /// Spectre 15h 8bps: 432000 + 2(8*3600) + 4(102)(204) + 2(102) + 2 = 573038 ~ 19.9h
    /// Rounding this up for simplicity and practical application.
    pub const NEW_PRUNING_DURATION: u64 = 121_500; // 33.8 hours = 972000 Blocks
