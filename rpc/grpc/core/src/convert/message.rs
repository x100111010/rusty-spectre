...
from!(item: &spectre_rpc_core::AcceptedTxEntry, protowire::AcceptedTxEntry, {
    Self {
...
from!(item: &spectre_rpc_core::MergesetBlockAcceptanceData, protowire::MergesetBlockAcceptanceData, {
    Self {
...
try_from!(item: &protowire::AcceptedTxEntry, spectre_rpc_core::AcceptedTxEntry, {
    Self {
        transaction_id: spectre_rpc_core::RpcTransactionId::from_str(&item.transaction_id)?,
        index_within_block: item.index_within_block,
    }
});

try_from!(item: &protowire::MergesetBlockAcceptanceData, spectre_rpc_core::MergesetBlockAcceptanceData, {
    Self {
        block_hash: RpcHash::from_str(&item.block_hash)?,
        accepted_txs: item
            .accepted_txs
            .iter()
            .map(spectre_rpc_core::AcceptedTxEntry::try_from)
