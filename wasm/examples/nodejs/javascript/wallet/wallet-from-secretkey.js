...
(async()=>{
    ...
    try {
                ...
                case "balance":
                    ...
                    Object.keys(balance).map(id=>{
                        ...
                        list.push({
                            ...
                            Mature: sompiToSpectreString(b.mature),
                            Pending: sompiToSpectreString(b.pending),
                            Outgoing: sompiToSpectreString(b.outgoing),
        ...
        let transferResult = await wallet.accountsTransfer({
            ...
            transferAmountSompi: spectreToSompi("2.456"),
        });
